                            ...
                            <tr>
                                ...
                                <td>
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    ...
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        ...
                                                                        <tr>
                                                                            <td valign="top" align="center">
                                                                                <img src="cid:logoMasterNetImoveis" alt="Master netimoveis" title="Master netimoveis" width="200" height="120">
                                                                            </td>
                                                                        </tr>
                                                                        </tbody>
                                                                    </table>
                                        ...
                                        <div class="movableContent" style="border: 0px; padding-top: 0px; position: relative;; margin-left: 20px">
                                                                        ...
                                                                        <tr>
                                                                            <td width='40'>
                                                                                <div class='contentEditableContainer contentFacebookEditable'>
                                                                                    <div class='contentEditable' style='text-align: center;color:#AAAAAA;'>
                                                                                        <a href="https://www.facebook.com/masterrsmimoveis" target="_blank">
                                                                                            <img src="cid:facebookIcon" alt="facebook" width='40' height='40' data-max-width="40" data-customIcon="true" border="0">
                                                                                        </a>
                                                                                    </div>
                                                                                </div>
                                                                            </td>
                                                                            ...
                                                                            <td width='40'>
                                                                                <div class='contentEditableContainer contentTwitterEditable'>
                                                                                    <div class='contentEditable' style='text-align: center;color:#AAAAAA;'>
                                                                                        <a href="https://www.instagram.com/masterrsmimoveis/" target="_blank">
                                                                                            <img src="cid:instagramIcon" alt="twitter" width='40' height='40' data-max-width="40" data-customIcon="true" border="0">
                                                                                        </a>
                                                                                    </div>
                                                                                </div>
                                                                            </td>
                                                                            ...
                                                                            <td width='40'>
                                                                                <div class='contentEditableContainer contentImageEditable'>
                                                                                    <div class='contentEditable' style='text-align: center;color:#AAAAAA;'>
                                                                                        <a href="https://blog.masterimoveis.com.br" target="_blank">
                                                                                            <img src="cid:blogIcon" alt="Social media" width='40' height='40' data-max-width="40" border="0">
                                                                                        </a>
                                                                                    </div>
                                                                                </div>
                                                                            </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class='contentEditableContainer contentTextEditable'>
                                                            <div class='contentEditable' style='text-align: center;color:#AAAAAA;'>
                                                                <p>
                                                                    Enviado automaticamente via sistema, favor não responder !
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </td>
