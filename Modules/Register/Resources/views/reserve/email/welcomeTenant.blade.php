                                                                ...
                                                                <td class="specbundle">
                                                                    <div class='contentEditableContainer contentTextEditable'>
                                                                        <div class='contentEditable' style='text-align: left;'>
                                                                            <h4 style="font-size: 20px; margin-top: 0px; margin-bottom: 0px">{!! $data['text_mail'] !!}</h4>
                                                                            <br>
                                                                            <p>
                                                                                <img src="cid:welcomeTenant">
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                                ...
                                                                                <div class='contentEditableContainer contentFacebookEditable'>
                                                                                    <div class='contentEditable' style='text-align: center;color:#AAAAAA;'>
                                                                                        <a href="https://www.facebook.com/masterrsmimoveis" target="_blank">
                                                                                            <img src="cid:facebookIcon" alt="facebook" width='40' height='40' data-max-width="40"
                                                                                                 data-customIcon="true" border="0">
                                                                                        </a>
                                                                                    </div>
                                                                                </div>
                                                                            </td>
                                                                                ...
                                                                                <div class='contentEditableContainer contentTwitterEditable'>
                                                                                    <div class='contentEditable' style='text-align: center;color:#AAAAAA;'>
                                                                                        <a href="https://www.instagram.com/masterrsmimoveis/" target="_blank">
                                                                                            <img src="cid:instagramIcon" alt="twitter" width='40' height='40' data-max-width="40"
                                                                                                 data-customIcon="true" border="0">
                                                                                        </a>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class='contentEditableContainer contentImageEditable'>
                                                                                    <div class='contentEditable' style='text-align: center;color:#AAAAAA;'>
                                                                                        <a href="https://blog.masterimoveis.com.br" target="_blank">
                                                                                            <img src="cid:blogIcon" alt="Social media" width='40' height='40' data-max-width="40"
                                                                                                 border="0">
                                                                                        </a>
                                                                                    </div>
                                                                                </div>
