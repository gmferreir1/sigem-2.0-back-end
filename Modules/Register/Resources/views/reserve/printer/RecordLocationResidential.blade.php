...
<div style="border: 1px solid black; height: 90px; margin-bottom: 3px;">
    ...
    <div style="width: 100%;">
        ...
        <div style="width: 60%; margin-left: 31%; margin-top: 4%">
            <span style="font-size: 15px; font-weight: bold">
                PROPOSTA LOCAÇÃO DE IMÓVEL RESIDENCIAL Nº {{$data['code_reserve']}}
            </span>
        </div>
...
<div>
    ...
    <div class="border" style="height: 45px; margin-top: 10px">
        ...
        <div style="width: 20%; float: left;" class="border sub-border">
            <p class="text">Possui Animais ?</p>
            <p class="text">&nbsp;</p>
        </div>

        <div style="width: 30%; float: left;" class="border sub-border">
            <p class="text">Prazo Contrato / Meses: </p>
            <p class="text">&nbsp;</p>
        </div>
    ...
    <div class="border" style="height: 120px; margin-top: 10px; padding-left: 5px; padding-top: 10px">
    ...
    <div class="border" style="height: 270px; margin-top: 15px; padding-left: 5px; text-align: justify">

        <div style="width: 95%; float: left; margin-top: 5px">
            a)- <span style="font-weight: bold"> Nos casos de locação de imóveis que façam parte de condomínios, caberá exclusivamente ao pretendente à
            Locação, antes da celebração do Contrato, consultar o Síndico / administrador do condomínio sobre os dias e
            horários permitidos para mudança, bem como se informar sobre as normas/convenção do condomínio,
            especialmente no que diz respeito a criação de animais. </span>
        </div>
        <div style="width: 95%; float: left; margin-top: 5px">
    ...
    <div class="border" style="height: 50px; margin-top: 15px; padding-left: 5px">
    ...
    <div class="border" style="height: 150px; margin-top: 30px">

        <div style="width: 80%; float: left; height: 150px;" class="border sub-border">
