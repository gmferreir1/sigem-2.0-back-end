...
use Modules\Chat\Repositories\MessageRepositoryEloquent;
use Modules\Chat\Repositories\OnlineUserRepository;
use Modules\Chat\Repositories\OnlineUserRepositoryEloquent;
...
class ChatServiceProvider extends ServiceProvider
{
    ...
    {
        $this->app->bind(OnlineUserRepository::class, OnlineUserRepositoryEloquent::class);
